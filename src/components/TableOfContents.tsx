...
const tableOfContents = {
  'STORAGE': {
    ...
    'Create filesystems in Lambda On-Demand Cloud to persist files and data with your compute.': 2,
  ...
  'HOST & SHARE GENERATIVE AI APPS': {
    'Easy hosting: Lambda Demos simplifies the hosting of Gradio-powered Generative AI apps.': 1,
  ...
  'SPEND LESS': {
    'Affordable: Lambda Cloud Clusters are the most affordable cloud GPU solution on the market.': 1,
